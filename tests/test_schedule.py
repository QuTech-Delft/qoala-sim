from qoala.runtime.schedule import NetworkSchedule


def test_network_schedule():
    # [0, 100), [500, 600), [1000, 1100) etc
    schedule1 = NetworkSchedule(bin_length=100, first_bin=0, bin_period=500)
    ...
    schedule1 = NetworkSchedule(bin_length=100, first_bin=150, bin_period=200)
