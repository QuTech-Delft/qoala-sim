...
def is_valid_name(name: str) -> bool:
    ...
    Acceptable names:
    - Percent identifiers (generated by the compiler): '%' followed by one or more digits (e.g. %1, %42)
    - Standard identifiers: letters(a-z, A-Z), numbers(0-9), underscores(_);
        must start with a letter and not be a reserved keyword
