...
class MemoryManager(Protocol):
    ...
    def _get_free_comm_phys_id(self) -> int:
        ...
        self._logger.error(f"No free comm qubits (phys mappings: { {p:(self._physical_mapping[p].pid,self._physical_mapping[p].virt_id) for p in self._qdevice.get_comm_qubit_ids()} })")
        raise AllocError
