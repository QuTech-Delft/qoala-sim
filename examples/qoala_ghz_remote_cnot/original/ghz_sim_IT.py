...
def perfect_trapped_ion_qdevice(
    ...
    topology = LhiTopologyBuilder.trapped_ionq_default_perfect_gates(num_qubits)
    print(';;;;;;;;;;;;;;;;;')
    print(topology.multi_gate_infos)
...
def load_program(name: str, interactions: dict) -> QoalaProgram:
    ...
    with open(path) as file:
        text = file.read()
    program = QoalaParser(text, flavour=TrappedIonFlavour(), transpiler=True).parse()
