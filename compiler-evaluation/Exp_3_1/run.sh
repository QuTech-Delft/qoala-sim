...
# fidelities="single_gate_fid 0.95 0.97 0.99 0.995 0.999"

# qnos_instr_time="qnos_instr_proc_time 1e3 3e3 5e3 7e3 1e4 3e4 5e4 7e4 1e5 3e5 5e5 7e5 1e6"
host_instr_time="host_instr_time 1e2 3e2 5e2 7e2 1e3 3e3 5e3 7e3 1e4 3e4 5e4 7e4 1e5"
# host_peer_latency="host_peer_latency 1e2 3e2 5e2 7e2 1e3 3e3 5e3 7e3 1e4 3e4 5e4 7e4 1e5"
