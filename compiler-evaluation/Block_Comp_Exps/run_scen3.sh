...
configs=("./configs/scen3/NV_0.json" "./configs/scen3/TI_0.json")
configs=("./configs/scen3/NV_1.json" "./configs/scen3/TI_1.json")
configs=("./configs/scen3/NV_2.json" "./configs/scen3/TI_2.json")
